...
def build_bowtie2_index( data_manager_dict, fasta_filename, params, target_directory, dbkey, sequence_id, sequence_name, data_table_name=DEFAULT_DATA_TABLE_NAME):
    ...
    #tmp_dir = tempfile.mkdtemp( prefix='tmp-data-manager-bowtie2-index-builder-' )
    ...
    args.append( sym_linked_fasta_filename )
    tmp_stderr = tempfile.NamedTemporaryFile( prefix = "tmp-data-manager-bowtie2-index-builder-stderr" )

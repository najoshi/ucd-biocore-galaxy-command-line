...
class SelectToolParameter( ToolParameter ):
    ...
    def get_legal_values( self, trans, other_values ):
        def _get_UnvalidatedValue_value( value ):
            ...
            return value
        if self.options:
            #log.debug("Here1:"+', '.join(self.legal_values))
    ...
    def from_html( self, value, trans=None, context={} ):
        ...
        #log.debug("Legal values: "+', '.join(legal_values))
        ...
        if isinstance( value, list ):
            ...
            for v in value:
                if v not in legal_values:
                    raise ValueError( "An invalid option was selected ("+v+"), please verify" )
                rval.append( v )
            return rval
        else:
            ...
            if value not in legal_values:
                raise ValueError( "An invalid option was selected ("+value+","+', '.join(legal_values)+"), please verify" )
            return value
...
class DrillDownSelectToolParameter( SelectToolParameter ):
    ...
    def from_html( self, value, trans=None, other_values={} ):
        ...
        rval = []
        for val in value:
            if val not in self.get_legal_values( trans, other_values ): raise ValueError( "An invalid option was selected ("+val+"), please verify" )
            rval.append( val )
        return rval
